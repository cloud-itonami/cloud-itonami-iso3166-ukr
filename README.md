# cloud-itonami-iso3166-ukr

Open ISO 3166 Blueprint for **UKR**: Ukraine.
...
tax registration, and local-content rules in Ukraine, so the operator
...
- **Not the government of Ukraine.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Ukrainian-licensed counsel
...
(ISO 3166 `UKR`). Required capabilities:
