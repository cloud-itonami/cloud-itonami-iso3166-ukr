(ns marketentry.store
  "SSoT for the UKR market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems UA" :portal "Prozorro"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ua-entity? true :has-ua-entity? true
             :requires-edrpou? true :edrpou-verified? true
             :drafted? false :submitted? false
             :jurisdiction "UKR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Prozorro"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ua-entity? true :has-ua-entity? true
             :requires-edrpou? true :edrpou-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Prozorro"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "UKR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Prozorro"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ua-entity? true :has-ua-entity? false
             :requires-edrpou? true :edrpou-verified? true
             :drafted? false :submitted? false
             :jurisdiction "UKR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Prozorro"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ua-entity? true :has-ua-entity? true
             :requires-edrpou? true :edrpou-verified? false
             :drafted? false :submitted? false
             :jurisdiction "UKR" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Prozorro"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               ...
                               requires-edrpou? edrpou-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-ua-entity?)  (assoc :engagement/requires-ua-entity? requires-ua-entity?)
    (some? has-ua-entity?)       (assoc :engagement/has-ua-entity? has-ua-entity?)
    (some? requires-edrpou?)    (assoc :engagement/requires-edrpou? requires-edrpou?)
    (some? edrpou-verified?)    (assoc :engagement/edrpou-verified? edrpou-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-ua-entity? :engagement/has-ua-entity?
   :engagement/requires-edrpou? :engagement/edrpou-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-ua-entity? (boolean (:engagement/requires-ua-entity? m))
     :has-ua-entity? (boolean (:engagement/has-ua-entity? m))
     :requires-edrpou? (boolean (:engagement/requires-edrpou? m))
     :edrpou-verified? (boolean (:engagement/edrpou-verified? m))
